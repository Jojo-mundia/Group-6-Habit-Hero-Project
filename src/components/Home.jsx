  ...
  return (
    <div className="home-container">
      ...
      <section className="features-section">
        ...
        <div className="features-overlay">
          <div className="features-text">
            ...
            <p>
              Transform your daily routines into powerful habits that shape your
              future. Our intuitive app makes habit building effortless,
      ...
      <section
        ...
        style={{
          opacity: Math.min(1, Math.max(0, (scrollY - 800) / 400)), // Fade in based on scroll
          transform: `translateY(${Math.max(50, 50 - (scrollY - 800) / 10)}px)`, // Slide up on scroll
        }}
      >
        ...
        <div className="cta-content">
          ...
          <p>
            Join thousands who've already revolutionized their lives. Don't wait
            for tomorrow—your future self is counting on you to start today.
          </p>
